...
from backend.reasoning.nodes.intent_coercion import _RawClassification, coerce_raw
from backend.core.prompts import INTENT_CLASSIFICATION_SYSTEM_PROMPT
...
def intent_classification_node(state: IncidentGraphState) -> dict:
    ...
    user_prompt = (
        ...
        "  • No case is loaded AND the question is HOW-TO / procedural / guidance:\n"
        "    how to start, how to investigate, what steps to take, where to begin,\n"
        "    how to approach, what to do when, how to handle.\n"
        "    These are guidance requests — the new-problem path will provide structured\n"
        "    starting advice. Do NOT classify these as STRATEGY_ANALYSIS.\n"
        ...
        "  \u2022 The question is portfolio-level: patterns, failure types, recurring issues, systemic problems.\n"
        "  \u2022 The question asks qualitatively WHAT is happening \u2014 what failure types, what patterns, why.\n"
        "  \u2022 The question asks to LIST or IDENTIFY specific cases by status, location, country.\n"
        "  \u2022 'Most recurring', 'most common', 'what types', 'what patterns' \u2192 always STRATEGY_ANALYSIS.\n\n"
        ...
        "Qualitative patterns/failure types/systemic issues \u2192 STRATEGY_ANALYSIS. "
        "'Trending' or 'recurring' language alone does NOT imply KPI.\n"
        "6. When truly ambiguous \u2192 OPERATIONAL_CASE.\n\n"
        "=== SCOPE RULES ===\n"
