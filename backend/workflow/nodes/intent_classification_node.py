...
class IntentClassificationNode:
    ...
    def run(
        ...
        user_prompt = (
            ...
            "4. TIEBREAKER — KPI_ANALYSIS vs STRATEGY_ANALYSIS: If the question asks for numbers, counts, rates, durations, frequencies, or trends that could be expressed as a chart or metric, prefer KPI_ANALYSIS. Only use STRATEGY_ANALYSIS when the question is asking for narrative insight, patterns, or organisational conclusions that cannot be answered with a number or chart.\n"
