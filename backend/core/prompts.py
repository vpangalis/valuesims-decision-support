...
QUESTION_READINESS_USER_PROMPT_TEMPLATE = (
    ...
    "- Questions asking HOW TO start, how to approach, how to begin, or what steps to follow "
    "for a type of failure or problem \u2014 are always ready regardless of case status. "
    "These are guidance or procedural questions, not case-specific investigation questions \u2014 "
    "return ready=true.\n"
